...
import 'package:hmz/appointment/editAppointment.dart';
import 'package:hmz/appointment/showAppointment.dart';
...
class ShowTodaysAppointmentScreen extends StatefulWidget {
  ...
  String idd;
  String useridd;
  ShowTodaysAppointmentScreen(this.idd, this.useridd);

  @override
  ShowTodaysAppointmentScreenState createState() =>
      ShowTodaysAppointmentScreenState(this.idd, this.useridd);
}
...
class ShowTodaysAppointmentScreenState
  ...
  Future<List<AppintmentDetails>> _responseFuture() async {
    ...
    //     "api/getMyTodaysAppoinmentList?group=doctor&id=" +
    //     doctor_id);
                                                                      ...
                                                                      FlatButton(
                                                                        ...
                                                                        onPressed:
                                                                          ...
                                                                          Navigator.of(context)
                                                                              .pushReplacementNamed(ShowTodaysAppointmentScreen.routeName);
                                                                        },
                                                                      )
                                                                    ],
                                                                  );
