...
class ProfileState extends State<Profile> {
  ...
  final String url = Auth().linkURL + "api/getProfile?id=";
        ...
        showDialog(
            ...
            builder: (BuildContext context) {
              return AlertDialog(
                ...
                content: Text(AppLocalizations.of(context).changesUpdatedSuccessfuly),
                actions: [
                  FlatButton(
    ...
    return Scaffold(
        appBar: AppBar(
          ...
          leading: IconButton(
            ...
            onPressed: () => Navigator.of(context).pushReplacementNamed(SettingScreen.routeName),
          ),
                      ...
                      child: Container(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                              labelText: '${AppLocalizations.of(context).email} (${AppLocalizations.of(context).notChangable})',
